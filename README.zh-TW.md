...
以下為真實 Windows 效果，使用者名稱已模糊處理。鎖定／登入畫面由手機拍攝，開始功能表由系統錄影。僅展示這台電腦上的效果，不代表所有 Windows 版本或 Microsoft 帳戶卡片皆支援。

### 鎖定／登入畫面

![鎖定／登入畫面](docs/images/in-action/lockscreen.gif)

### 開始功能表

![開始功能表](docs/images/in-action/start-menu.gif)
